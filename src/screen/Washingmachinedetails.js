            ...
            <View style={{ width: "100%", backgroundColor: "#172647", paddingVertical: 12, paddingHorizontal: 12, flexDirection: "row", alignItems: "center" }}>
                ...
                <View style={{ paddingLeft: 5 }}>
                    <Text style={{ fontSize: responsiveFontSize(2), color: "#fff" }}>
                        Washing Machine services && Repair
                    </Text>
                </View>
            </View>
                        ...
                        <View
                            ...
                            <View style={{ width: "40%" }}>
                                <View style={{ width: "100%", height: 120, }}>
                                    <Image
                                        source={require('../assets/was2.jpg')}
                        ...
                        <View
                            ...
                            <View style={{ width: "60%" }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => navigation.navigate("Vendorlist")} style={{
                                        backgroundColor: "#172647",
                                        marginTop: 9,
                                        paddingVertical: 5,
                                        borderRadius: 50,
                    ...
                    <View style={{ width: "100%", backgroundColor: "#fff", elevation: 2, borderRadius: 5, marginTop: 5 }}>
                        <View
                            ...
                            <View style={{ width: "40%" }}>
                                <View style={{ width: "100%", height: 120, }}>
                                    <Image
                                        source={require('../assets/was12.jpg')}
                                        style={{ width: "100%", height: "100%", borderRadius: 5 }}
                                        resizeMode="cover"
                                    />
                                </View>
                    ...
                    <View style={{ width: "100%", backgroundColor: "#fff", elevation: 2, borderRadius: 5, marginTop: 5 }}>
                        <View
                            ...
                            <View style={{ width: "40%" }}>
                                <View style={{ width: "100%", height: 120, }}>
                                    <Image
                                        source={require('../assets/was23.jpg')}
                                        style={{ width: "100%", height: "100%", borderRadius: 5 }}
                                        resizeMode="cover"
                                    />
                                </View>
                    ...
                    <View style={{ width: "100%", backgroundColor: "#fff", elevation: 1, borderRadius: 5 }}>
                        <View
                            ...
                            <View style={{ width: "60%" }}>
                                ...
                                <View style={{ marginTop: 3 }}>
                                    <Text style={{
                                        ...
                                        Top load (fully automati) checkup
                                    </Text>
                                </View>
                            ...
                            <View style={{ width: "40%" }}>
                                <View style={{ width: "100%", height: 120, }}>
                                    <Image
                                        source={require('../assets/was8.jpg')}
                                        style={{ width: "100%", height: "100%", borderRadius: 5 }}
                                        resizeMode="stretch"
                                    />
                                </View>
