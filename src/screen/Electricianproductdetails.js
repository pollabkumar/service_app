...
const Electricianproductdetails = () => {
                    ...
                    <View style={{ width: "100%", backgroundColor: "#fff", elevation: 1, borderRadius: 5 }}>
                        <View
                            ...
                            <View style={{ width: "60%" }}>
                                ...
                                <TouchableOpacity 
                                onPress={()=>navigation.navigate("Vendorlist",{data:"AC Installation "})}
                                style={{
                                    backgroundColor: "#172647",
                                    marginTop: 9,
                                    paddingVertical: 5,
                            ...
                            <View style={{ width: "40%" }}>
                                <View style={{ width: "100%", height: 120, }}>
                                    <Image
                                        source={require('../assets/acrepair.jpg')}
                    ...
                    <View style={{ width: "100%", backgroundColor: "#fff", elevation: 2, borderRadius: 5, marginTop: 5 }}>
                        <View
                            ...
                            <View style={{ width: "60%" }}>
                                ...
                                <TouchableOpacity
                               onPress={()=>navigation.navigate("Vendorlist",{data:"AC UnIstallation "})}
                                // onPress={()=>}
                                style={{
                                    backgroundColor: "#172647",
                                    marginTop: 9,
...
export default Electricianproductdetails
