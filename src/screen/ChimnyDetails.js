                        ...
                        <View style={{ width: "60%" }}>
                            ...
                            style={{
                                ...
                                <Text style={{
                                    ...
                                    fontSize: responsiveFontSize(1.5),
                                    fontWeight: "500",
                                }}> Select Chimney Technician</Text>
                            </TouchableOpacity>
                        </View>
                ...
                <View style={{ width: "100%", backgroundColor: "#fff", elevation: 2, borderRadius: 5, marginTop: 5 }}>
                    <View
                        ...
                        <View style={{ width: "40%" }}>
                            <View style={{ width: "100%", height: 120, }}>
                                <Image
                                    source={require('../assets/f198.jpg')}
                                    style={{ width: "100%", height: "100%", borderRadius: 5 }}
                                    resizeMode="stretch"
                                />
                            </View>
                ...
                <View style={{ width: "100%", backgroundColor: "#fff", elevation: 1, borderRadius: 5,marginTop: 5  }}>
                    <View
                        ...
                        <View style={{ width: "40%" }}>
                            <View style={{ width: "100%", height: 120, }}>
                                <Image
                                    source={require('../assets/ch33.jpg')}
                                    style={{ width: "100%", height: "100%", borderRadius: 5 }}
                                    resizeMode="cover"
                                />
                            </View>
