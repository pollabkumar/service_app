      ...
      <ScrollView>
        ...
        <View style={{ marginHorizontal: 8, marginTop: 4 }}>
          <View style={{ width: "100%", backgroundColor: "#d7dff2", padding: 10, flexDirection: "row", borderRadius: 10 }}>
            {/* Image Section */}
            <View style={{ width: "30%", height: 125, borderRadius: 10, overflow: "hidden" }}>
              <Image
            ...
            <View style={{ width: "70%", paddingLeft: 10 }}>
              ...
              <View style={{
                ...
                {/* Review Button */}
                <TouchableOpacity
                  onPress={() => setratingmodelopen(true)}
                  style={{
                    backgroundColor: "#172647",
                    paddingVertical: 8,
                  ...
                  <Text style={{ color: "#fff", fontWeight: "bold", fontSize: responsiveFontSize(1.7) }}>Add Review</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ color: "#fff", fontWeight: "bold", fontSize: responsiveFontSize(1.7) }}>Book Now</Text>
                </TouchableOpacity>
...
export default CompletedVendorList
